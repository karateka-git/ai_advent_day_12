...
- если есть незакоммиченные изменения и пользователь переходит к новому смысловому блоку, нужно явно остановиться и напомнить про коммит;
- до ответа пользователя на это напоминание не переходить к следующей реализации;
